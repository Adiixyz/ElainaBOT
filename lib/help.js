...
╠➥ *${prefix}banchat*
╠➥ *${prefix}unbanchat*
╠➥ *${prefix}setname [texts]*
╠➥ *${prefix}setstatus [texts]*
╠➥ *${prefix}setprofilepic*
╠➥ *${prefix}eval [Code JavaScript]*
║
╚═〘 ITSUKI BOT 〙`
}
...
╠➥ *${prefix}gift @tagmember amount*
╠➥ *${prefix}unban @tagmember*
╠➥ *${prefix}daftarulang @tagmember age*
╠➥ *${prefix}spamcall [number]*
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *ITSUKI*
...
╠➥ *SEWA : FREE/GRUP (BULAN)*
╠➥ *BUAT : 2K (BISA JADI OWNER)*
╠➥ PEMBAYARAN : PULSA
╠═══════════════════════════
╠➥ *KEUNTUNGAN SEWA BOT :*
╠➥ *1. BISA MENJADI ADMIN ITSUKI*
